angular.module('wui.date',[]).directive('wuiDate', function() {
	...
	function fieldTemplate(scope, element, attr) {
		return(
			...
			'<span class="txt" ng-click="openMonthPicker()"><span>{{date.month}}</span> </span>' +
			'</span>' +
			...
			'</td>' +
			'<td>' +
			'<a class="cell" ng-click="selectMonth(6)">June</a>' +
			'</td>' +
			'<td>' +
			'<a class="cell" ng-click="selectMonth(7)">July</a>' +
			'</td>' +
			'<td>' +
			...
			'<tr>' +
			'<td>' +
			'<a class="cell" ng-click="selectMonth(9)">Sept</a>' +
			'</td>' +
			'<td>' +
			...
			'<span class="title">' +
			'<span class="txt"><span>{{date.yearList.startYear}}</span> Year - <span>{{date.yearList.endYear}}</span> </span>' +
			'</span>' +
			'<i class="iconfont" ng-click="pickNextYear()">&#xe640;</i>' +
			'</div>' +			'<div class="wui-date-picker_content">' +
			'<table class="wui-data-table">' +
			'<tr>' +
